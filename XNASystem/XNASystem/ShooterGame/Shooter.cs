...
namespace XNASystem.Shooter
{
	class Shooter : IGame, IScreen
	{
		...
		public void StartGame(int level)
		{
			...
			#region 2nd level
			ShooterHerd enemies2 = new ShooterHerd((float)0.5, 0, 0, Width, Height);
			...
			#region 3rd level
			ShooterHerd enemies3 = new ShooterHerd((float)1, 0, 0, Width, Height);
			ShooterHerd boss3 = new ShooterHerd((float)1.5, 0, 0, Width, Height);
			...
			#region 4th level
			ShooterHerd enemies4 = new ShooterHerd((float)1, 0, 0, Width, Height);
			...
			#region 5th level
			ShooterHerd enemies5 = new ShooterHerd((float)1.5, 0, 0, Width, Height);
			...
			#region 6th level
			ShooterHerd enemies6 = new ShooterHerd((float)1, 0, 0, Width, Height);
			ShooterHerd enemies6ai = new ShooterHerd((float)2.5, 0, 0, Width / 2, Height);
			ShooterHerd enemies6aii = new ShooterHerd((float)2.5, Width / 2, 0, Width, Height);
			ShooterHerd boss6 = new ShooterHerd((float)2, 0, 0, Width, Height);
			...
			#region 7th level
			ShooterHerd enemies7 = new ShooterHerd((float)1.5, 0, 0, Width, Height);
			ShooterHerd enemies7a = new ShooterHerd((float)3, 0, 0, Width, Height);
		...
		public void Draw(SpriteBatch spriteBatch, List<SpriteFont> fonts, List<Texture2D> textures)
		{
			...
			//draw text
			spriteBatch.DrawString(fonts[0], "Lives: " + _lives, new Vector2(Width - 100, 0), Color.White);
