...
{
	class CreateBookletMenu : IScreen
	{
		#region variables
		...
		#region constructor
		public CreateBookletMenu(Stack<IScreen> stack, SystemMain main, EditorMainMenu editor)
		{
			_up = 1;
			_down = 1;
			_enter = 1;
		...
		public void Draw(SpriteBatch spriteBatch, List<SpriteFont> fonts, List<Texture2D> textures, int height, int width)
		{
			...
			//draw the title
			spriteBatch.DrawString(fonts[0], "Create a New Booklet", new Vector2(250, 100), Color.Black);
			...
			spriteBatch.DrawString(fonts[0], "Submit Booklet", new Vector2(60, 350), Color.Black);
